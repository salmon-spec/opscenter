...
OPSCENTER_HTTP_BIND=0.0.0.0
OPSCENTER_HTTP_PORT=80
OPSCENTER_API_BIND=127.0.0.1
OPSCENTER_API_PORT=9091
LOKI_BIND_IP=$local_host
LOKI_PORT=3100
LOKI_DATA_DIR=/opt/opscenter-data/loki
LOKI_PUBLIC_URL=http://$local_host:3100
...
ensure_env OPSCENTER_HTTP_BIND 0.0.0.0
ensure_env OPSCENTER_HTTP_PORT 80
ensure_env OPSCENTER_API_BIND 127.0.0.1
ensure_env OPSCENTER_API_PORT 9091
ensure_env LOKI_BIND_IP "$local_host"
...
echo "OpsCenter Docker installation completed: http://$local_host/"
