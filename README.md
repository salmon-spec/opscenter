...
| 项 | 状态 |
|---|---|
| 后端测试 | **pytest 154/154 全绿**（0 失败 0 错误，含服务事件上下文与探活错误分类） |
...
| Agent | v2.4.0 |
| 版本里程碑 | **v4.6.1**（事件信息补全、探活错误分类与 CI 去重） |
