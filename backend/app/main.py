    ...
    try:
        ...
        with get_db() as db:
            ...
            if result.get("success"):
                ...
                row.agent_version = result.get("agent_version", "2.5.1")
            else:
    ...
    if srv.agent_status == "running" and srv.agent_port:
        ...
        if agent_data:
            ...
            normalized = {
                ...
                "memory_cached": agent_data.get("memory_cached", 0),
                "memory_buffers": agent_data.get("memory_buffers", 0),
                "swap": agent_data.get("swap_percent", 0),
                "swap_total": agent_data.get("swap_total", 0),
                "swap_used": agent_data.get("swap_used", 0),
                "swap_free": agent_data.get("swap_free", 0),
            ...
            return {
                ...
                "disks": agent_data.get("disks", []),
                "disk_devices": agent_data.get("disk_devices", []),
                "network_interfaces": agent_data.get("network_interfaces", []),
                "top_cpu_processes": agent_data.get("top_cpu_processes", []),
                "top_memory_processes": agent_data.get("top_memory_processes", []),
                "container_stats": agent_data.get("container_stats", []),
...
def get_agent_metrics_api(server_id: str):
    ...
    normalized = {
        ...
        "memory_cached": data.get("memory_cached", 0),
        "memory_buffers": data.get("memory_buffers", 0),
        "swap": data.get("swap_percent", 0),
    ...
    return {
        ...
        "disk_devices": data.get("disk_devices", []),
