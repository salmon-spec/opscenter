...
def discover_docker_services(server: Server, db: Session, host: str = "39.99.157.36") -> List[Service]:
...
def parse_nginx_config(config_path: str = "/etc/nginx-source/nginx.conf", host: str = "39.99.157.36") -> List[Dict]:
