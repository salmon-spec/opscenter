<template>
  <div class="view files-view">
    ...
    <section class="card browser">
      ...
      <div class="statusbar"><span>{{ meta.total || 0 }} 项<span v-if="meta.truncated">（仅显示前 2000 项）</span></span><span class="muted">删除操作会移入 ~/.opscenter-trash，可在主机上恢复</span></div>
    </section>
