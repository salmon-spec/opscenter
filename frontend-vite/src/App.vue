...
const navs = [
  ...
  { label: '系统', icon: '▥', children:[{path:'/system/files',label:'文件'},{path:'/system/monitor',label:'监控'},{path:'/system/terminal',label:'终端'},{path:'/system/firewall',label:'防火墙'},{path:'/system/ssh',label:'SSH 管理'},{path:'/system/processes',label:'进程管理'}] },
